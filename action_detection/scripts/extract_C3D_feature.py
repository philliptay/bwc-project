...
caffe_root = '/n/fs/vai-bwc-scr/action_detection/C3D/C3D-v1.0/'
...
def check_trained_model(trained_model):
    ...
    if os.path.isfile(trained_model):
        ...
        download_cmd = [
                ...
                #"https://www.dropbox.com/s/qqfrg6h44d4jb46/c3d_resnet18_sports1m_r2_iter_2800000.caffemodel?dl=0",
                ]
...
def run_C3D_extraction(feature_prototxt, ofile, feature_layer, trained_model):
    ...
    return_code = subprocess.check_call(feature_extraction_cmd)
...
For example, "python {} {}" will extract features from an example image.'''.format(
    ...
    trained_model = os.path.join(
       ...
       # "c3d_ucf101_feature_extraction",
        #"c3d_resnet18_sports1m_r2_iter_2800000.caffemodel"
        )
    # check model
    ...
    # feature to extract
    feature_layer = 'fc6-1' #'pool5 res5b' 

    # overwrite feature output?
    force_overwrite = False

    # by default, use 16 frames
    num_frames_per_clip = 30 # edit for BWC

    # sampling rate (in seconds)
    sample_every_N_sec = 1 # BWC

    # don't extract beyond this (in seconds)
    max_processing_sec = 900
    ...
    #feature_prototxt = os.path.join(
    #   caffe_root,
    #   "examples",
    #   "c3d_ucf101_feature_extraction",
    #   "c3d_resnet18_ucf101_feature_extraction.prototxt"
    #   )
