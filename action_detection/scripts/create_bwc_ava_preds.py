...
tw_titles = [IDs_to_titles[vid_id] for vid_id in TWs]

if __name__ == "__main__":
    for title in tw_titles:
         subprocess.call(["python",os.path.join(root_dir,"action_detection/slowfast/tools/run_net.py"),"--cfg",
                          ...
                          "TEST.ENABLE","False", "DEMO.ENABLE", "True", "DEMO.INPUT_VIDEO",str(os.path.join(vid_dir, title)),
                          'DEMO.PREDS_BOXES',''])
